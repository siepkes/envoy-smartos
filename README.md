...
```
# pkgin -y install go119 ninja-build gcc13 git-base zip unzip openjdk11 libtool cmake automake ninja-build autoconf gmake python311 py311-expat
```
