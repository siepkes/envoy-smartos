...
Wheter you are on Triton or on SmartOS you need to create a native (`joyent` brand) container for the build. Steps below are performed on a container running the `base-64` image version `24.4.1` (`2f1dc911-6401-4fa4-8e9d-67ea2e39c271`).
...
```
# pkgin -y install go119 ninja-build gcc13 git-base zip unzip openjdk11 libtool cmake automake ninja-build autoconf gmake python311
```
