/* illumos / SmartOS c-ares config. Derived from config_linux/ares_config.h with the
 * one Solaris-family difference that affects compilation: getservbyport_r takes 5 args
 * (returns struct servent*) on illumos, not the 6-arg glibc form -> GETSERVBYPORT_R_ARGS 5.
 * (getservbyname_r is unused here -- GETSERVBYNAME_R_ARGS is left undefined as on Linux.) */
#pragma once
