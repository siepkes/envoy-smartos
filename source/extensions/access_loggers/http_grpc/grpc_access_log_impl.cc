...
void HttpGrpcAccessLog::responseFlagsToAccessLogResponseFlags(
    envoy::output::accesslog::v2::AccessLogCommon& common_access_log,
  ...
  if (request_info.getResponseFlag(RequestInfo::ResponseFlag::UnauthorizedExternalService)) {
    common_access_log.mutable_response_flags()->mutable_unauthorized_details()->set_reason(
        envoy::output::accesslog::v2::ResponseFlags_Unauthorized_Reason::
  ...
  if (request_info.protocol()) {
    ...
    case Http::Protocol::Http10:
      log_entry->set_protocol_version(
          envoy::output::accesslog::v2::HTTPAccessLogEntry::HTTP10);
      break;
    case Http::Protocol::Http11:
      log_entry->set_protocol_version(
          envoy::output::accesslog::v2::HTTPAccessLogEntry::HTTP11);
      break;
    case Http::Protocol::Http2:
      log_entry->set_protocol_version(
          envoy::output::accesslog::v2::HTTPAccessLogEntry::HTTP2);
      break;
    }
  }
